...
@Component
public class MicroTerminalHandler extends TextWebSocketHandler {
    ...
    public void afterConnectionEstablished(WebSocketSession session) throws Exception {
        ...
        processBuilder.directory(new File("/app/exercises/src/main/java")); // Start in main java directory

        Map<String, String> env = processBuilder.environment();
        env.put("TERM", "xterm-256color");
        env.put("PS1", "$ ");
        env.put("HOME", "/app/exercises/src/main/java");  // Set HOME for Micro editor
        ...
        // Send initial message and launch Micro editor
        session.sendMessage(new TextMessage("Micro Editor Terminal - Use 'micro <filename>' to edit files\r\n"));
    }
